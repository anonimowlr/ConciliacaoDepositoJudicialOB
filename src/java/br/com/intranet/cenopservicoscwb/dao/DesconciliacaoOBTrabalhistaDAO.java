 ...
 * @author PC_LENOVO
 */
public class DesconciliacaoOBTrabalhistaDAO implements CrudDAO<DesconciliacaoOB> {
    ...
    public Boolean avaliarParaSalvar(DesconciliacaoOB entidade) {
      ...
      GrupoTratamentoDAO tratamentoDAO = new GrupoTratamentoDAO();
        ...
        try {
            ...
            Logger.getLogger(DesconciliacaoOBTrabalhistaDAO.class.getName()).log(Level.SEVERE, null, ex);
        }
