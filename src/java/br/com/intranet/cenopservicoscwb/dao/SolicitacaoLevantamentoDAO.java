...
public class SolicitacaoLevantamentoDAO implements CrudDAO<SolicitacaoLevantamento>{
    ...
    public List<SolicitacaoLevantamento> buscarPorParametro(DesconciliacaoOB entidade) throws ErroSistema {
       
        
        
        try {
            Connection con = ConnectionFactory.conectar("retab");
            String sql = "SELECT * FROM rejud.tb_cpj_cadastro where NPJ like '%' ? '%'";
