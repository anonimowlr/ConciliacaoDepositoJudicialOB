 ...
 */
@Entity
@Table(name = "tb_historico_desconciliacao_ob_paj")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "HistoricoDesconciliacao.findAll", query = "SELECT h FROM HistoricoDesconciliacao h")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCodigoHistorico", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.codigoHistorico = :codigoHistorico")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCodigoDesconciliacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.codigoDesconciliacao = :codigoDesconciliacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByNpj", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.npj = :npj")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByVariacaoNpj", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.variacaoNpj = :variacaoNpj")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByContaControle", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.contaControle = :contaControle")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByContaDepositaria", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.contaDepositaria = :contaDepositaria")
    , @NamedQuery(name = "HistoricoDesconciliacao.findBySaldoContaControle", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.saldoContaControle = :saldoContaControle")
    , @NamedQuery(name = "HistoricoDesconciliacao.findBySaldoDeposito", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.saldoDeposito = :saldoDeposito")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByValorDesconciliacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.valorDesconciliacao = :valorDesconciliacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findBySituacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.situacao = :situacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByDataSituacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.dataSituacao = :dataSituacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByFuncionarioResponsavelSituacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.funcionarioResponsavelSituacao = :funcionarioResponsavelSituacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByFuncionarioAtual", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.funcionarioAtual = :funcionarioAtual")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByNomeTratamento", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.nomeTratamento = :nomeTratamento")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByAvocado", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.avocado = :avocado")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByDataAvocacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.dataAvocacao = :dataAvocacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByDataDesconciliacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.dataDesconciliacao = :dataDesconciliacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByDiasDesconciliado", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.diasDesconciliado = :diasDesconciliado")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByDataEntradaBd", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.dataEntradaBd = :dataEntradaBd")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByMesTratamento", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.mesTratamento = :mesTratamento")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByPrefixo", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.prefixo = :prefixo")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCodigoFuncao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.codigoFuncao = :codigoFuncao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByUorLocalizacao", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.uorLocalizacao = :uorLocalizacao")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByProcessoNoGsv", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.processoNoGsv = :processoNoGsv")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCodigoProcesso", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.codigoProcesso = :codigoProcesso")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCodigoAtividade", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.codigoAtividade = :codigoAtividade")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCodigoDetalheAtividade", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.codigoDetalheAtividade = :codigoDetalheAtividade")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCodigoTarefa", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.codigoTarefa = :codigoTarefa")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByCargoGerencial", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.cargoGerencial = :cargoGerencial")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByTipoChave", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.tipoChave = :tipoChave")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByQuantidadeProcessoConcluido", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.quantidadeProcessoConcluido = :quantidadeProcessoConcluido")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByQuantidadeProcessoDevolvido", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.quantidadeProcessoDevolvido = :quantidadeProcessoDevolvido")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByQuantidadeTarefaConcluida", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.quantidadeTarefaConcluida = :quantidadeTarefaConcluida")
    , @NamedQuery(name = "HistoricoDesconciliacao.findByQuantidadeTarefaDevolvida", query = "SELECT h FROM HistoricoDesconciliacao h WHERE h.quantidadeTarefaDevolvida = :quantidadeTarefaDevolvida")})
